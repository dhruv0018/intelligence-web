...
function SelfEditingControlsController (
    ...
    function onSetPlayStartTimeClick() {
        ...
        $rootScope.$broadcast('self-edited-play-state-notifier-did-create', $scope.currentPlay);
    ...
    function onSetPlayEndTimeClick() {
        ...
        $rootScope.$broadcast('self-edited-play-state-notifier-did-create-finish', $scope.currentPlay);
    }

    function onCancel() {
        $rootScope.$broadcast('self-edited-play-state-notifier-did-delete', $scope.currentPlay);
