export default `
    ...
    <div ng-show="ctrl.CURRENT_SELF_EDITOR_STATE === ctrl.EDITOR_STATE" class="self-editing-header">
        ...
        <button class="btn btn-primary" ng-click="ctrl.toggleSelfEditorState()">
    ...
    <div class="main-highlight" ng-class="{'editing-mode': ctrl.CURRENT_SELF_EDITOR_STATE === ctrl.EDITOR_STATE}">
        ...
        <krossover-sidebar>
            ...
            <div class="breakdown-sidebar-footer" ng-if="ctrl.CURRENT_SELF_EDITOR_STATE === ctrl.BREAKDOWN_STATE">
