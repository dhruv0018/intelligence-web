...
<div class="self-editing-playlist">
    ...
    <div ng-if="!filteredPlayList.isEmpty()">
        ...
        <div class="playlist-tagging-controls">
            ...
            <custom-tags-dropdown feature="CustomTags" plays="selectedPlays" for-self-editor="true" disabled="!selectedPlays.length"></custom-tags-dropdown>
        </div>
