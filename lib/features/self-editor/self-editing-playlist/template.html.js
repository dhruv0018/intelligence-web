...
<div class="self-editing-playlist">
    <div class="clips-header" ng-show="currentSelfEditorState === EDITOR_STATE"><h3>Clips</h3></div>
    ...
    <div ng-if="!filteredPlayList.isEmpty()">
        ...
        <div class="playlist-tagging-controls" ng-if="!hideEditingOptions">
            ...
            <button feature="SelectPlays" class="btn btn-sm btn-default" open-modal="AddReel.Modal" modal-options="addToReeOptions" ng-disabled="!selectedPlays.length">Add to Reel</button>
