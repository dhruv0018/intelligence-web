...
<div class="self-editing-playlist">
    ...
    <div ng-if="!filteredPlayList.isEmpty()">
        ...
        <div class="playlist-tagging-controls" ng-if="!hideEditingOptions">
            ...
            <add-reel-dropdown
                feature="SelfEditorReels"
                disabled="!selectedPlays.length"
                plays="selectedPlays"
                for-self-editor="true">
            </add-reel-dropdown>
        ...
        <div class="playlist-item-list" ng-class="hideEditingOptions? 'hide-playlist-header' : ''">
            <div
            ...
            >
                <div class="playlist-item-content">
                    ...
                    <i ng-show="currentSelfEditorState === BREAKDOWN_STATE" class="self-edit-telestration-icon" ng-class="{'icon icon-telestration pull-right' : isPlayContainingTelestration(play)}"></i>
                </div>
