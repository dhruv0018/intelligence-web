...
Videoplayer.run([
    ...
    function run($templateCache) {
        ...
        $templateCache.put('krossover-slow-forward-button.html', require('./krossover-slow-forward-button.html'));
        $templateCache.put('krossover-fast-forward-button.html', require('./krossover-fast-forward-button.html'));
        $templateCache.put('krossover-slow-backward-button.html', require('./krossover-slow-backward-button.html'));
