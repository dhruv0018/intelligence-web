/* Component settings */
var templateUrl = 'coach/game-area-information/game-info.html';
 ...
 * @module GameInfo
 */
var GameInfo = angular.module('game-area-info', []);
    ...
    function config($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('ga-info-basic', {
                ...
                parent: 'ga-info',
                views: {
                    'ga-info-basic@ga-info': {
                        templateUrl: templateUrl,
                        controller: 'GameAreaInformationBasicController'
                    }
                }
            });
    }
 ...
 * @type {Controller}
 */
GameInfo.controller('GameAreaInformationBasicController', [
    '$scope', '$state', '$localStorage', 'GAME_TYPES', 'GAME_NOTE_TYPES', 'GameAreaTabs', 'SessionService', 'TeamsFactory', 'LeaguesFactory', 'GamesFactory',
    function controller($scope, $state, $localStorage, GAME_TYPES, GAME_NOTE_TYPES, tabs, session, teams, leagues, games) {

        console.log('in the ga-info controller');

        $scope.GAME_TYPES = GAME_TYPES;

        $scope.$storage = $localStorage;

        console.log($scope.$storage.game.datePlayed);
