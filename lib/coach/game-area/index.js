...
GameArea.controller('GameAreaController', [
    '$scope', '$state', '$stateParams', '$localStorage', 'SessionService', 'GamesFactory', 'TeamsFactory',
    function controller($scope, $state, $stateParams, $localStorage, session, games, teams) {
        ...
        games.get($scope.gameId, function(game) {
            ...
            $scope.$storage.game.isHomeGame = game.isHomeGame + '';
