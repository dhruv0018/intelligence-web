...
YourTeam.controller('YourTeamController', [
    ...
    function controller($scope, $state, $localStorage, tabs, players) {
        ...
        $scope.players[4].jerseyNumbers[$scope.rosterId] = '98';
        $scope.players[5].jerseyNumbers[$scope.rosterId] = '11';
        $scope.players[6].jerseyNumbers[$scope.rosterId] = '53';
        $scope.players[7].jerseyNumbers[$scope.rosterId] = '29';
        $scope.players[8].jerseyNumbers[$scope.rosterId] = '30';
        $scope.players[9].jerseyNumbers[$scope.rosterId] = '65';
        $scope.players[10].jerseyNumbers[$scope.rosterId] = '87';
        $scope.players[11].jerseyNumbers[$scope.rosterId] = '34';
