...
UploadingFilm.controller('UploadingFilmController', [
    'config', '$rootScope', '$scope', '$state', 'GamesFactory', 'UploadingFilmTabs',
    function controller(config, $rootScope, $scope, $state, games, tabs) {
        ...
        $scope.cancel = function() {
            ...
            request.del(config.kvs.uri + 'upload/' + $scope.$storage.game.guid);
