...
GameInfo.controller('GameInfoController', [
    '$scope', '$state', '$localStorage', 'GAME_TYPES', 'UploadingFilmTabs', 'SessionService', 'TeamsFactory', 'LeaguesFactory', 'GamesFactory',
    function controller($scope, $state, $localStorage, GAME_TYPES, tabs, session, teams, leagues, games) {
