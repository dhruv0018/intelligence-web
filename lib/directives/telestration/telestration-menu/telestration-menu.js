        ...
        function link(scope, elem) {
            ...
            elem.on('click', function() {
                ...
                if (scope.clickCount % 2 === 0) {
                    ...
                    telestrationInterface.selectedGlyphType = scope.dropdownState;
                }

                scope.$apply();
            });

            scope.$watch('selectedGlyphType', function(type) {
...
TelestrationMenu.directive('telestrationMenu', [
    '$timeout', 'VG_STATES', 'VG_EVENTS', 'TelestrationInterface', 'TELESTRATION_TYPES', 'dropdownToolStates',
    function($timeout, VG_STATES, VG_EVENTS, telestrationInterface, TELESTRATION_TYPES, toolStates) {
        return {
            restrict: 'E',
