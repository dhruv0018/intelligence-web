...
Telestration.directive('telestration', [
    '$state', 'TelestrationInterface', 'ShapesFactory', '$window', 'EventEmitter', 'EVENT_MAP',
    function($state, telestrationInterface, Shapes, $window, emitter, EVENT_MAP) {
        function postlink(scope, elem, attr, API) {
            ...
            function telestrationStart(mouseEvent) {
                ...
                newGlyph = Shapes.createShape(telestrationInterface.selectedGlyphType);
