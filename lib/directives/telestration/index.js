                    ...
                    if (startPoint && startPoint.length && endPoint && endPoint.length) {
                        ...
                        switch (scope.glyphObject.getType()) {
                            ...
                            case TELESTRATION_TYPES.CONE:
                                ...
                                updatedSVGShape = angular.element('<svg height="' + containerBox.height + '" width="' + containerBox.width + '">' +
                                    '<path d="M ' + startPoint[0] + ' ' + startPoint[1] + ' L ' + conePoint1[0] + ' ' + conePoint1[1] + ' C' + curveReferencePoint1[0] + ' ' + curveReferencePoint1[1] + ' ' + curveReferencePoint2[0] + ' ' + curveReferencePoint2[1] + ' ' + conePoint2[0] + ' ' + conePoint2[1] + ' z" stroke="' + scope.glyphObject.getColor() + '" stroke-width="' + BORDER_WIDTH + '" fill="none" />' +
                                '</svg>');
                                break;
