                        ...
                        switch (scope.glyphObject.getType()) {
                            ...
                            case TELESTRATION_TYPES.ARROW:
                                ...
                                updatedSVGShape = angular.element('<svg height="' + containerBox.height + '" width="' + containerBox.width + '">' +
                                    arrowHeadDef +
                                    '<path d="M ' + startPoint[0] + ' ' + startPoint[1] + ' L ' + endPoint[0] + ' ' + endPoint[1] + ' " stroke="' + scope.glyphObject.getColor() + '" stroke-width="' + BORDER_WIDTH + '" marker-end="url(' + $location.absUrl() + '#TriangleArrowHeadSVG' + ')" />' +
                                '</svg>');
                                break;
                            ...
                            case TELESTRATION_TYPES.T_BAR:
                                ...
                                updatedSVGShape = angular.element('<svg height="' + containerBox.height + '" width="' + containerBox.width + '">' +
                                    '<path d="M ' + startPoint[0] + ' ' + startPoint[1] + ' L ' + endPoint[0] + ' ' + endPoint[1] + ' M ' + tPoint1[0] + ' ' + tPoint1[1] + ' L ' + tPoint2[0] + ' ' + tPoint2[1] + '" stroke="' + scope.glyphObject.getColor() + '" stroke-width="' + BORDER_WIDTH + '" />' +
                                '</svg>');
                                break;
