    ...
    function($state, telestrationInterface, $window, emitter, EVENT_MAP, Glyphs) {
        function postlink(scope, elem, attr, API) {
            ...
            var telestrationStart = function telestrationStart(mouseEvent) {
                ...
                // create new glyph
                var newGlyph = Glyphs.createGlyph(telestrationInterface.selectedGlyphType, telestrationInterface.telestrationSVG, telestrationInterface.selectedGlyphColor);
