...
module.exports = [
    ...
    function($state, telestrationInterface, $window, emitter, EVENT_MAP, Glyphs, PlayManager) {
        ...
        function postlink(scope, elem, attr, API) {
            ...
            var telestrationEntity = scope.film[telestrationsDataKey];
            ...
            var telestrationStart = function telestrationStart(mouseEvent) {
                ...
                var telestration = telestrationEntity.getTelestration(currentTelestrationTime, scope.film.id, currentPlayId);
            ...
            var timeUpdateHandler = function timeUpdateHandler(e) {
                ...
                telestrationEntity.forEach(function(savedTelestration) {
            ...
            var playVideoHandler = function playVideoHandler(e) {
                ...
                telestrationEntity.forEach(function updateShown(telestration) {
