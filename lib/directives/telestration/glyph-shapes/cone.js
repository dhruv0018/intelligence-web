angular.module('GlyphShapes.ConeShape', []).factory('ConeFactory', [
    ...
    function(telestrationInterface, ShadowShape, TELESTRATION_TYPES) {
        ...
        function Cone() {
            ...
            ShadowShape.call(this, TELESTRATION_TYPES.CONE, telestrationInterface.telestrationSVG.path(), telestrationInterface.telestrationSVG.path());
        ...
        Cone.prototype.render = function renderCone() {
