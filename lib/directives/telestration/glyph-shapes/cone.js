angular.module('GlyphShapes.ConeShape', []).factory('ConeFactory', [
    ...
    function(telestrationInterface, ShadowShape) {
        ...
        Cone.prototype.render = function renderCone(vertices, color, text) {
            ...
            var conePoint1 = [];
            var conePoint2 = [];
            conePoint1[0] = endPoint.x - (coneOpeningWidth / 2) * dx;
            conePoint1[1] = endPoint.y - (coneOpeningWidth / 2) * dy;
            conePoint2[0] = endPoint.x + (coneOpeningWidth / 2) * dx;
            conePoint2[1] = endPoint.y + (coneOpeningWidth / 2) * dy;
            ...
            this.spotShadow.plot('M ' + startPoint.x + ' ' + startPoint.y + ' L ' + conePoint1[0] + ' ' + conePoint1[1] + ' C' + curveReferencePoint1[0] + ' ' + curveReferencePoint1[1] + ' ' + curveReferencePoint2[0] + ' ' + curveReferencePoint2[1] + ' ' + conePoint2[0] + ' ' + conePoint2[1] + ' z');
