angular.module('GlyphShapes.TBarShape', []).factory('TBarFactory', [
    ...
    function(telestrationInterface, Shape) {
        ...
        TBar.prototype.render = function renderTBar(vertices, color, text) {
            ...
            var tPoint1 = [];
            var tPoint2 = [];
            tPoint1[0] = endPoint[0] - (this.T_BAR_LENGTH / 2) * dx;
            tPoint1[1] = endPoint[1] - (this.T_BAR_LENGTH / 2) * dy;
            tPoint2[0] = endPoint[0] + (this.T_BAR_LENGTH / 2) * dx;
            tPoint2[1] = endPoint[1] + (this.T_BAR_LENGTH / 2) * dy;
