    ...
    function(telestrationInterface, glyphShapesConstants, TELESTRATION_TYPES, $location) {
        ...
        function Circle() {
            ...
            self.render = function renderCircle(vertices, color, text) {
                ...
                self.currentShape.radius(Math.abs(offsetX), Math.abs(offsetY))
        ...
        function ShadowCircle() {
            ...
            self.render = function renderShadowCircle(vertices, color, text) {
                ...
                if (typeof self.currentShape === 'undefined' && telestrationInterface.telestrationSVG) {
                    self.currentShape = 1;//telestrationInterface.telestrationSVG.circle().opacity(0);
