...
GlyphShapes.factory('GlyphShapeRenderer', [
    ...
    function(telestrationInterface, glyphShapesConstants, TELESTRATION_TYPES, $location) {
        ...
        ShapeRenderer.prototype.movebale = true;
        ...
        function TBar() {
            ...
            this.render = function renderTBar(vertices, color, text) {
        ...
        function Circle() {
            ...
            this.render = function renderCircle(vertices, color, text) {
        ...
        function ShadowCircle() {
            ...
            this.currentShape = telestrationInterface.telestrationSVG.circle();
            this.editable = false;
            this.render = function renderShadowCircle(vertices, color, text) {
        ...
        function Cone() {
            ...
            this.render = function renderCone(vertices, color, text) {
        ...
        function Freehand() {
            ...
            this.render = function renderFreehand(vertices, color, text) {
        ...
        function TextBox() {
            ...
            this.render = function renderTextBox(vertices, color, text) {
        ...
        function ShapeRenderer(glyphElement, type) {
            ...
            shapeTypeObj.registerListeners();
            console.log(shapeTypeObj, ShapeRenderer.prototype, new Circle());
            return shapeTypeObj;
        }

        ShapeRenderer.prototype.registerListeners = function() {
            var self = this;
            self.currentShape.on('click', function(mouseEvent) {
                console.log(mouseEvent, self);
