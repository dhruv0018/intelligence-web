    ...
    function(telestrationInterface) {
        ...
        return {
            ...
            controller: function() {
                ...
                self.resizeWidgetRadius = 30;
                self.resizeWidgetOffset = -self.resizeWidgetRadius / 2;
                ...
                function updateResizeWidgetsPos(startVertex, endVertex) {
                    ...
                    var startX = startVertex[0] + self.resizeWidgetOffset;
                    var startY = startVertex[1] + self.resizeWidgetOffset;
                    var endX = endVertex[0] + self.resizeWidgetOffset;
                    var endY = endVertex[1] + self.resizeWidgetOffset;
                ...
                function createResizeWidget() {
                    ...
                    var strokeWidth = '3';
                    var strokeColor = '#000';
                    var radius = self.resizeWidgetRadius;
                ...
                function startPointMove(delta, event) {
                    ...
                    var startX = this.dragStartXPos + delta.x - self.resizeWidgetOffset;
                    var startY = this.dragStartYPos + delta.y - self.resizeWidgetOffset;
                    var endX = self.endResizeWidget.x() - self.resizeWidgetOffset;
                    var endY = self.endResizeWidget.y() - self.resizeWidgetOffset;
                ...
                function endPointMove(delta, event) {
                    ...
                    // remove widget offset from points
                    var startX = self.startResizeWidget.x() - self.resizeWidgetOffset;
                    var startY = self.startResizeWidget.y() - self.resizeWidgetOffset;
                    var endX = this.dragStartXPos + delta.x - self.resizeWidgetOffset;
                    var endY = this.dragStartYPos + delta.y - self.resizeWidgetOffset;
