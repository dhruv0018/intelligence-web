    ...
    function(telestrationInterface) {
        ...
        return {
            ...
            controller: function() {
                ...
                self.resizeWidgetCenterOffset = -self.resizeWidgetRadius / 2;
                ...
                function startPointMove(delta, event) {
                    ...
                    var startX = this.dragStartXPos + delta.x - self.resizeWidgetCenterOffset;
                    var startY = this.dragStartYPos + delta.y - self.resizeWidgetCenterOffset;
                ...
                function endPointMove(delta, event) {
                    ...
                    var endX = this.dragStartXPos + delta.x - self.resizeWidgetCenterOffset;
                    var endY = this.dragStartYPos + delta.y - self.resizeWidgetCenterOffset;
