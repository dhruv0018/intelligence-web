...
Breakdown.controller('Breakdown.controller', [
    '$scope', 'ROLES', 'Mediator', 'VideoPlayerEventEmitter', 'VideoPlayer', 'SessionService', 'PlaysManager', 'PlayManager', 'EventManager', 'VIDEO_PLAYER_EVENTS',
    function controller($scope, ROLES, Mediator, VideoPlayerEventEmitter, videoPlayer, session, playsManager, playManager, eventManager, VIDEO_PLAYER_EVENTS) {
