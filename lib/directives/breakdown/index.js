...
Breakdown.controller('Breakdown.controller', [
    '$scope', 'ROLES', 'Mediator', 'CurrentEventBroker', 'VideoPlayerEventEmitter', 'VideoPlayer', 'SessionService', 'PlaysManager', 'PlayManager', 'EventManager', 'VIDEO_PLAYER_EVENTS',
    function controller($scope, ROLES, Mediator, currentEventBroker, VideoPlayerEventEmitter, videoPlayer, session, playsManager, playManager, eventManager, VIDEO_PLAYER_EVENTS) {
