...
Breakdown.controller('Breakdown.controller', [
    '$scope', 'EVENT', 'ROLES', 'Mediator', 'PlaylistEventEmitter', 'VideoPlayerEventEmitter', 'VideoPlayer', 'SessionService', 'PlaysManager', 'PlayManager', 'EventManager', 'VIDEO_PLAYER_EVENTS',
    function controller($scope, EVENT, ROLES, Mediator, playlistEventEmitter, VideoPlayerEventEmitter, videoPlayer, session, playsManager, playManager, eventManager, VIDEO_PLAYER_EVENTS) {
