...
Breakdown.controller('Breakdown.controller', [
    '$scope', 'ROLES', 'Mediator', 'PlaylistEventEmitter', 'VideoPlayerEventEmitter', 'VideoPlayer', 'SessionService', 'PlaysManager', 'PlayManager', 'EventManager', 'VIDEO_PLAYER_EVENTS',
    function controller($scope, ROLES, Mediator, playlistEventEmitter, VideoPlayerEventEmitter, videoPlayer, session, playsManager, playManager, eventManager, VIDEO_PLAYER_EVENTS) {
        ...
        playlistEventEmitter.on('WATCH_PLAY', changePlay);
