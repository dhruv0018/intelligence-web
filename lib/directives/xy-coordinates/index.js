...
XYCoordinates.directive('xyCoordinates', [
    ...
    function directive($parse) {
        ...
        function link($scope, element, attributes) {
            ...
            $scope.relativeCoordinates = $scope.$parent.$eval(attributes.ngModel);
            ...
            function onRelativeCoordinatesChange(relativeCoordinates) {

                ngModel.assign($scope, relativeCoordinates);
                adjustMarkerPosition(relativeCoordinates);
            }
        }
