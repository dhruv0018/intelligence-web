...
Info.controller('Coach.Game.Info.controller', [
    ...
    function controller(
        ...
        $scope.gameTeams = {
            team: ($scope.teams[$scope.game.teamId]) ? $scope.teams[$scope.game.teamId] : teams.create({isCustomerTeam: false, leagueId: $scope.league.id, sportId: $scope.league.sportId, isCanonical: 0}),
            opposingTeam: ($scope.teams[$scope.game.opposingTeamId]) ? $scope.teams[$scope.game.opposingTeamId] : teams.create({isCustomerTeam: false, leagueId: $scope.league.id, sportId: $scope.league.sportId, isCanonical: 0})
        };
