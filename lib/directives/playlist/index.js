...
Playlist.controller('Playlist.controller', [
    '$scope', 'EVENT', 'VIDEO_PLAYER_EVENTS', 'ROLES', 'Mediator', 'PlaylistEventEmitter', 'VideoPlayerEventEmitter', 'VideoPlayer', 'SessionService', 'PlaysManager', 'PlayManager', 'EventManager',
    function controller($scope, EVENT, VIDEO_PLAYER_EVENTS, ROLES, Mediator, playlistEventEmitter, VideoPlayerEventEmitter, videoPlayer, session, playsManager, playManager, eventManager) {
