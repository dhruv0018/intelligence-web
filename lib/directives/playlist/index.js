...
Playlist.controller('Playlist.controller', [
    '$scope', 'VIDEO_PLAYER_EVENTS', 'ROLES', 'Mediator', 'CurrentEventBroker', 'VideoPlayerEventEmitter', 'VideoPlayer', 'SessionService', 'PlaysManager', 'PlayManager', 'EventManager',
    function controller($scope, VIDEO_PLAYER_EVENTS, ROLES, Mediator, currentEventBroker, VideoPlayerEventEmitter, videoPlayer, session, playsManager, playManager, eventManager) {
