...
function IndexerScriptLink ($scope, element, attributes, controller) {

    const elementsManager = controller.elementsManager;
     ...
     */
    function autoClickFirstFieldElement (delay) {
        ...
        if (firstFieldElement === null) {
            ...
            window.setTimeout(() =>
                autoClickFirstFieldElement(delay),
                delay
            );
    ...
    autoClickFirstFieldElement(timeoutFrequency);
}
