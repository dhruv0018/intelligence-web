...
>
    ...
    ><a ng-href="{{MOBILE_APP_URLS.COACH.ANDROID}}" target="_blank">Coach</a> and <a ng-href="{{MOBILE_APP_URLS.ATHLETE.ANDROID}}" target="_blank">Athlete</a> Android apps are also available.</p>
...
>
    ...
    <p
        class="other-app-platform-links"
    ><a ng-href="{{MOBILE_APP_URLS.COACH.IOS_PUBLIC}}" target="_blank">Coach</a> and <a ng-href="{{MOBILE_APP_URLS.ATHLETE.IOS_PUBLIC}}" target="_blank">Athlete</a> iOS apps are also available.</p>
