...
PlayerInformation.directive('playerInformation', [
    ...
    function directive(
        ...
        function link(scope) {
            ...
            let leagueForHighlight = leagues.get(scope.team.leagueId);
            let season = leagueForHighlight.getSeasonForWSC();
        ...
        const PlayerInformation = {
            ...
            templateUrl: 'lib/directives/player-information/template.html',
