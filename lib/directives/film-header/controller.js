    ...
    if (angular.isDefined($scope.film)) {
        if($scope.film.description === 'games') {
            ...
            if ($scope.film.teamId) {
                ...
                $scope.showGameHighlightLink = team.getSport().id === SPORTS.BASKETBALL.id;
                $scope.showReelHighlightLink = typeof [SPORTS.BASKETBALL.id, SPORTS.LACROSSE.id].find((sportId) => (sportId === team.getSport().id)) !== 'undefined';
            }
            ...
            if (isAthlete) {
                $scope.showGameHighlightLink = false;
                $scope.showReelHighlightLink = false;
                ...
                athleteRoles.forEach(athleteRole => {
                    ...
                    if (team.getSport().id === SPORTS.BASKETBALL.id) {
                        $scope.showGameHighlightLink = true;
                    }

                    if (typeof [SPORTS.BASKETBALL.id, SPORTS.LACROSSE.id].find((sportId) => (sportId === team.getSport().id)) !== 'undefined') {
                        $scope.showReelHighlightLink = true;
                    }
                });
            } else if (isCoach) {
