...
filmHeader.controller('filmHeader.Controller', [
    '$scope','GAME_TYPES_IDS', 'GAME_TYPES', 'SessionService', 'ShareFilm.Modal', 'BasicModals', 'AccountService', 'config', 'AuthenticationService',
    function controller($scope, GAME_TYPES_IDS, GAME_TYPES, session, ShareFilmModal, modals, account, config, auth) {
