...
filmHeader.directive('filmHeader', [
    '$timeout', 'TeamsFactory', 'GAME_TYPES_IDS', 'GAME_TYPES', 'SessionService', 'AuthenticationService', 'ROLES', 'ShareFilm.Modal', 'BasicModals', 'AccountService',
    function directive($timeout, teams, GAME_TYPES_IDS, GAME_TYPES, session, auth, ROLES, ShareFilmModal, modals, account) {
        ...
        function link($scope, element, attrs) {
            ...
            $scope.toggleReelPublishing = function() {
                ...
                if (!$scope.film.publishedToProfile) {
                    $scope.film.publishToProfile();
                } else if ($scope.film.publishedToProfile) {
