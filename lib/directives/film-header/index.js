...
filmHeader.directive('filmHeader', [
    'TeamsFactory', 'GAME_TYPES_IDS', 'GAME_TYPES', 'SessionService', 'ROLES', 'ShareFilm.Modal',
    function directive(teams, GAME_TYPES_IDS, GAME_TYPES, session, ROLES, ShareFilmModal) {
        ...
        function link($scope, element, attrs) {
            ...
            $scope.isUploader = currentUser.currentRole.id === $scope.film.uploaderUserId;
        }
