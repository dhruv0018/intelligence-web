...
filmHeader.directive('filmHeader', [
    'TeamsFactory', 'GAME_TYPES_IDS', 'GAME_TYPES', 'SessionService', 'AuthenticationService', 'ROLES', 'ShareFilm.Modal', 'BasicModals', 'AccountService',
    function directive(teams, GAME_TYPES_IDS, GAME_TYPES, session, auth, ROLES, ShareFilmModal, modals, account) {
        ...
        if ($scope.isClip) {
            ...
            $scope.isCoachOnUploaderTeam =
                session.currentUser.is(ROLES.COACH) &&
