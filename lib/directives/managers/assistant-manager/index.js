...
AssistantManager.directive('assistantManager', [
    'ROLES', 'UsersFactory',
    function directive(ROLES, users) {
        ...
        var assistantManager = {
            ...
            link: function(scope, element, attributes) {
                ...
                scope.addNewAssistantCoach = function() {
                    ...
                    assistantCoach.firstName = 'foo';
                    assistantCoach.lastName = 'bar';

                    //TODO temporary emails
                    assistantCoach.email = 'testingEmail' + Math.floor(Math.random() * 100) * Math.floor(Math.random() * 100) + '@krossover.com';

                    console.log(assistantCoach);
