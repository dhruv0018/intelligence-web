            ...
            link: function(scope, element, attributes) {
                ...
                scope.activeInactiveFilter = () => {
                    ...
                    return function(assistantCoach) {
                        let assistantCoachRoleForTeam = assistantCoach.getUserRoleForTeam(ROLES.ASSISTANT_COACH, scope.team);
                ...
                scope.addNewAssistantCoach = function() {
                    ...
                    var assistantInfoModal = AssistantInfo.open(options);
                    assistantInfoModal.result.then(function(newUser) {
                        if (newUser) scope.assistantCoaches.push(newUser);
                    });
