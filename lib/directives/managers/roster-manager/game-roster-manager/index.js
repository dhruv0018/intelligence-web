...
GameRosterManager.directive('gameRosterManager', [
    ...
    function directive($http, config, users, players, alerts, ExcelUpload, AthleteInfo, ROLES, playerRosterEntry, teams, session) {
        ...
        var rosterManager = {
            ...
            templateUrl: 'lib/directives/managers/roster-manager/game-roster-manager/template.html',
            scope: {
                team: '=?',
                positionset: '=?',
                rosterTemplateUrl: '=?',
        ...
        function post(scope, element, attributes) {
            ...
            scope.getPlayerJerseysAsNumbers = function(rosterEntry) {
                return Number(rosterEntry.playerInfo.jerseyNumber);
            };
...
export default GameRosterManager;
