...
function ArenaEventDirective(
    ...
    function arenaEventLink(scope, element, attributes) {
        ...
        console.log('scope.arenaEvent.teamId', scope.arenaEvent.teamId);
        console.log('game.teamId', game.teamId, 'game.opposingTeamId', game.opposingTeamId);
        if (scope.arenaEvent.teamId === game.teamId) {
            ...
            console.log('game.opposingJerseyColor', game.opposingJerseyColor);
