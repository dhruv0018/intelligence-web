...
class FieldsElementsManagerService {
    ...
    constructor (event) {
        ...
        // Store fields indicies based on the indexerScript order
        this.fieldsIndices = event.indexerScript.filter(scriptField => (scriptField.type !== 'STATIC'))
            .map(scriptField => Number.parseInt(scriptField.match(/\d/g)));
    ...
    setCurrentField (field) {
        ...
        this.currentFieldIndex = field.index;
    }
}
