                ...
                <div class="conference-header">
                    ...
                    <div class="conference-info">
                        ...
                        <input
                            ...
                            ng-init="updatedConferenceName = conference.name"
                            ng-model="updatedConferenceName"
                            ng-if="isEditingConference">
                    </div>
                    ...
                    <div class="conference-info">
                        ...
                        <select
                            ...
                            ng-if="isEditingConference"
                            ng-click="onInputClick($event)"
                            ng-init="updatedCompetitionLevel = conference.competitionLevel"
