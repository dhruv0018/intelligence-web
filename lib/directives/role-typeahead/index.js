        ...
        var roleTypeahead = {
            ...
            link: function($scope, element, attributes) {
                ...
                $scope.searchUsers = function() {
                    ...
                    .then(addSelectedRole)
                    .then(addSportNameToUsers)
                    .then(orderUsers);

                    function addSelectedRole(users) {
                        return users.map(setSelectedRole);
                    }

                    function setSelectedRole(user) {
                        user.role = user.getRoleByTeamId(user.team.id);
                        return user;
                    }
