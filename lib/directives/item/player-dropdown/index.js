...
PlayerDropdown.controller('PlayerDropdownController', [
    ...
    'PlayersFactory',
    '$timeout',
    function PlayerDropdownController($scope, ROLES, session, tagsets, teams, players, $timeout) {
        ...
        var team = ($scope.game.teamId) ? teams.get($scope.game.teamId) : {};
        var opposingTeam = ($scope.game.opposingTeamId) ? teams.get($scope.game.opposingTeamId) : {};
