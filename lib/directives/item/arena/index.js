 ...
 * @type {Directive}
 */
Arena.directive('krossoverItemArena', ['ROLES', 'SessionService', 'ArenaModal.Modal', 'ARENA_IDS', 'ARENA_REGIONS',

    function directive(ROLES, session, ArenaModal, ARENA_IDS, ARENA_REGIONS) {
        ...
        function link($scope, element, attributes) {
            ...
            $scope.$watch('variable.value.region', function(region) {
