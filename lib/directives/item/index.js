...
Item.controller('ItemController', [
    ...
    'GAPS',
    'GAP_IDS',
    function ItemController($scope, ROLES, $location, $anchorScroll, session, games, tagsets, players, ZONES, ZONE_IDS, GAPS, GAP_IDS) {
        ...
        $scope.onBlur = function() {
            ...
            $scope.determineResetButtonView();
        };
        ...
        $scope.determineResetButtonView = function(value) {
            switch($scope.item.type) {
                ...
                case 'PLAYER_DROPDOWN':
                    ...
                    $scope.resetButton.meta.jerseyNumber = isTeamPlayer ? teamRoster.playerInfo[value].jerseyNumber : opposingTeamRoster.playerInfo[value].jerseyNumber;
