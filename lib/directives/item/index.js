...
Item.controller('ItemController', [
                            ...
                            videoPlayer)
    {
        ...
        function openArenaDialog(event) {
            ...
            const videogularElement = document.getElementsByTagName('videogular')[0];
            ...
            //Check if video player is in full screen
            let videoPlayerIsFullscreen = videoPlayer.isFullScreen || document.fullscreenEnabled;

            //Depending on if video player is in full screen or not, set the parent to the videogular or indexing element
            let parent = videoPlayerIsFullscreen ? angular.element(videogularElement) : angular.element(indexingElement);

            arenaDialogPromise = ArenaDialog.show(event, parent, $scope.item, $scope.league);
