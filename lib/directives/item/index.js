...
//Item.filter('resultThrottle', function() {
//
//    return function (arr) {
//        console.log('inside filter', arr);
//        return arr;
//    };
//});
/**
    ...
    function ItemController($scope,
        ...
        switch($scope.item.type) {
            ...
            case 'PLAYER_TEAM_DROPDOWN':
                ...
                $scope.teamPlayerOptions = [team, opposingTeam].concat(playerlist.get());
                console.log($scope.teamPlayerOptions);
