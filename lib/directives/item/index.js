...
Item.controller('ItemController', [
    ...
    function ItemController($scope,
        ...
        if ($scope.game) {
            var teamPlayers = ($scope.reel) ? $scope.reelPlayerMap : $scope.game.getTeamPlayers();
            var opposingTeamPlayers = ($scope.reel) ? $scope.reelPlayerMap : $scope.game.getOpposingTeamPlayers();
            ...
            if ($scope.game) {
                switch($scope.item.type) {
                    ...
                    case 'PLAYER_TEAM_DROPDOWN':
                        ...
                        } else if (value && value.type && value.type === 'Team') {
