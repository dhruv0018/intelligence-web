...
Item.directive('krossoverItem', [
    ...
    'GAPS',
    'GAP_IDS',
    function directive(ROLES, $location, $anchorScroll, session, games, tagsets, ZONES, ZONE_IDS, GAPS, GAP_IDS)  {
        ...
        function link($scope, element, attributes) {
            ...
            */
            ...
            $scope.resetButton = {
                text: $scope.event.variableValues[$scope.item.id].value || 'Optional',  //initial value
            ...
            $scope.determineResetButtonView = function(value) {
                switch($scope.item.type) {
                    default:
                        $scope.resetButton.text = value || $scope.event.variableValues[$scope.item.id].value || 'Optional';
                        break;
                }
            };
