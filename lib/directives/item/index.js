    ...
    function ItemController($scope,
            ...
            if ($scope.game) {
                switch($scope.item.type) {
                    ...
                    case 'PLAYER_TEAM_DROPDOWN':
                        ...
                        $scope.resetButton.text = 'This is a test';
                            //(value === null) ? 'Optional' : (value && value.type && value.type === 'Team') ? $scope.teams[value].name : $scope.constructPlayerButtonView(value);
                        break;
                    default:
        ...
        $scope.constructPlayerButtonView = function constructPlayerButtonView(value) {
            ...
            if (value !== null) {
                ...
                switch(isTeamPlayer) {
                    case true:
                        $scope.resetButton.meta.jerseyNumber = teamRoster.playerInfo[value].jerseyNumber ? unlistedPlayerJersey: teamRoster.playerInfo[value].jerseyNumber;
                        break;
                    case false:
                        $scope.resetButton.meta.jerseyNumber = opposingTeamRoster.playerInfo[value].jerseyNumber ? unlistedPlayerJersey : opposingTeamRoster.playerInfo[value].jerseyNumber;
                        break;
                }
            } else {
