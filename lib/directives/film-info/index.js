...
filmInfo.directive('filmInfo', [
    ...
    function directive(teams) {
        ...
        function link($scope, element, attrs) {
            ...
            $scope.homeTeamExists = angular.isDefined($scope.film.teamId);
            $scope.opposingTeamExists = angular.isDefined($scope.film.opposingTeamId);

            $scope.teams = teams.getCollection();

            $scope.teamsExist = $scope.homeTeamExists || $scope.opposingTeamExists;
