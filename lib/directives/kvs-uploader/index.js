...
kvsUploader.directive('kvsUploader', [
    '$window', '$http', '$state', '$rootScope', 'AlertsService', 'ALLOWED_FILE_EXTENSIONS', 'config', 'flowFactory', 'TeamsFactory', 'FileUploadService',
    function directive($window, $http, $state, $rootScope, alerts, ALLOWED_FILE_EXTENSIONS, config, flow, teams, FileUploadService) {
