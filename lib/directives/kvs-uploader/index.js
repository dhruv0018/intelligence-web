...
kvsUploader.directive('kvsUploader', [
    '$http', '$state', '$rootScope', 'AlertsService', 'ALLOWED_FILE_EXTENSIONS', 'config', 'flowFactory',
    function directive($http, $state, $rootScope, alerts, ALLOWED_FILE_EXTENSIONS, config, flow) {
