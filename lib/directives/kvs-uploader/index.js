                ...
                .success((response) => {
                    ...
                    .success((data) => {
                        ...
                        .then((data) => {
                            ...
                            let uploadModel = FileUploadService.getUploadModel(scope.film.id, scope.flow);
                            ...
                            if (uploadModel) {
                                ...
                                console.error('Error: You are uploading too many files. Please wait until some finish in order to upload more');
                            }
                        });
