...
kvsUploader.directive('kvsUploader', [
    '$http', '$state', '$rootScope', 'AlertsService', 'ALLOWED_FILE_EXTENSIONS', 'config', 'flowFactory', 'uploadManager',
    function directive($http, $state, $rootScope, alerts, ALLOWED_FILE_EXTENSIONS, config, flow, uploadManager) {
