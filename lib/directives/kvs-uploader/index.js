...
kvsUploader.directive('kvsUploader', [
    '$window', '$http', '$state', '$rootScope', 'AlertsService', 'ALLOWED_FILE_EXTENSIONS', 'config', 'flowFactory', 'GamesUploadManager',
    function directive($window, $http, $state, $rootScope, alerts, ALLOWED_FILE_EXTENSIONS, config, flow, gamesUploadManager) {
        ...
        function link(scope) {
                ...
                .success((response) => {
                    ...
                    .success((data) => {
                        ...
                        .then((data) => {
                            ...
                            let uploadModel = gamesUploadManager.makeUploadModel(scope.film.id, scope.flow);
                            ...
                            if (uploadModel) {
                                ...
                                throw new Error('Error: You are uploading too many files. Please wait until some finish in order to upload more');
                            }
                        });
            ...
            function getGUID(response) {
                ...
                if (!response) {
                    ...
                    console.error(`required argument 'response' is undefined`);
                }
            ...
            function requestGUID(kvsUrl, partCount) {
                ...
                let url = 'http://v2-qa.krossover.com' + kvsUrl + '/upload';
            ...
            function requestUploadServerUrlFail(data) {
                ...
                throw new Error('Request for Upload Server URL. Please check your internet connection');
            }
            ...
            function prepareFilesForUpload(guid, kvsUrl) {
                ...
                scope.flow.opts.target = 'http://v2-qa.krossover.com' + kvsUrl + '/upload/part/' + guid;
