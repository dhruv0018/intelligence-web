...
FilmHomeTabs.directive('filmHomeTabs', [
    'SessionService', 'GamesFactory', 'ReelsFactory', 'GAME_TYPES', 'ROLES', 'config', 'Features',
    function directive(session, games, reels, GAME_TYPES, ROLES, config, features) {
        ...
        var filmHomeTabs = {
            ...
            link: function(scope, element, attrs) {
                ...
                if (features.isEnabled('SelfEditor')) {
                    // self editor
