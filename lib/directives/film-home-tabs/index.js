...
FilmHomeTabs.directive('filmHomeTabs', [
    'SessionService', 'GamesFactory', 'ReelsFactory', 'GAME_TYPES', 'ROLES', 'config', 'Features', 'SELF_EDITOR_TEAM_ID_WHITELIST',
    function directive(session, games, reels, GAME_TYPES, ROLES, config, features, SELF_EDITOR_TEAM_ID_WHITELIST) {
        ...
        var filmHomeTabs = {
            ...
            link: function(scope, element, attrs) {
                ...
                let currentTeamId = session.getCurrentTeamId();
                let currentTeamIsOnSelfEditorWhitelist = SELF_EDITOR_TEAM_ID_WHITELIST.some(whitelistId => currentTeamId === whitelistId);
                ...
                if (features.isEnabled('SelfEditor') && currentTeamIsOnSelfEditorWhitelist) {
                    // self editor
                    scope.filters.selfEditor = {
                        items: gamesList.filter(function(game) {
                            ...
                            return game.isSelfEdited;
                        }),
                        selected: false,
                        description: 'Self Edited',
                        id: 'filter-film-self-edited-cta'
                    };
                }
