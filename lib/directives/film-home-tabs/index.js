    ...
    function directive(session, games, reels, GAME_TYPES, ROLES, config) {
        ...
        var filmHomeTabs = {
            ...
            link: function(scope, element, attrs) {
                ...
                //TODO find out what this is (possible feature flag?), why we need it, and if we can get rid of it
                //TODO reduce massive duplication in these filters
                if (scope.reelsActive) {
