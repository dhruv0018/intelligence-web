...
Videoplayer.controller('krossoverVideoplayer.controller', [
    ...
    function($scope, $state, $sce, $modal, videoPlayer) {
        ...
        function updateMediaFragment(newClipTime) {
            ...
            if (newClipTime) {
                $scope.clipEndTimeReal = $scope.clipEndTime - $scope.clipStartTime;
                $scope.mediaFragmentURI = '#t=' + $scope.clipStartTime + ',' + $scope.clipEndTime;
            } else {
        ...
        $scope.onUpdateTime = function(currentTime, endTime) {
            $scope.currentClipTime = currentTime - $scope.clipStartTime || 0;
        };
