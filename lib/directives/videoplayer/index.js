...
Videoplayer.controller('Videoplayer.controller', [
    '$window', '$rootScope', 'config', '$scope', '$state', '$sce', '$modal', 'vgFullscreen', 'Videoplayer', 'VideoPlayerInstance', 'PlayManager', 'EventManager', 'EventEmitter', 'VG_CONFIG', 'VG_STATES', 'DEVICE',
    function controller($window, $rootScope, config, $scope, $state, $sce, $modal, vgFullscreen, videoplayer, videoPlayerInstance, playManager, eventManager, emitter, VG_CONFIG, VG_STATES, DEVICE) {
        ...
        $scope.testUrl = 'http://www.videogular.com/assets/images/videogular.png';
