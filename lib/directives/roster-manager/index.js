...
RosterManager.directive('krossoverRosterManager', [
    '$http', 'config', 'PlayersFactory', 'AlertsService',
    function directive($http, config, players, data, alerts) {
                    ...
                    $http.post(config.api.uri + 'batch/players/file',
                        ...
                        .success(function(uploadedPlayers) {
                            players.getList({
                                ...
                                scope.roster = players.constructPositionDropdown(roster, scope.rosterId, data.coachData.positionSet.indexedPositions);
                            });
