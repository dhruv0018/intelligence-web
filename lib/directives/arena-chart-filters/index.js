...
function ArenaChartFiltersDirective(
    ...
    function ArenaChartFiltersLink(scope, element, attributes) {
        ...
        scope.ngModel.teamPlayersIds = scope.ngModel.teamPlayersIds || [];
        scope.ngModel.opposingTeamPlayersIds = scope.ngModel.opposingTeamPlayerIds || [];

        /* General Team Filtering */
        scope.ngModel.teamId = scope.ngModel.teamId || game.teamId;
        scope.ngModel.opposingTeamId = scope.ngModel.opposingTeamId || game.opposingTeamId;
    }
