...
function ArenaChartFiltersDirective(
    ...
    function ArenaChartFiltersLink(scope, element, attributes) {
        ...
        scope.teamPlayerLabels = teamPlayerList.map(player => getPlayerLabel(player, teamRoster));
        scope.opposingTeamPlayerLabels = opposingTeamPlayerList.map(player => getPlayerLabel(player, opposingTeamRoster));
        ...
        function getPlayerLabel(player, roster) {
            ...
            let playerLabel = player.getPlayerLabel(roster);
            let positionNames = positionset.getPositionNames(roster.playerInfo[player.id].positionIds);
