        ...
        function link($scope, element, attributes, controller) {
            ...
            function compileTemplate(template) {
                ...
                if (template) {
                    ...
                    eventsHTMLString = $sce.trustAsHtml(template);
                } else if (isIndexer) {
            ...
            playlistEventEmitter.on(EVENT.PLAYLIST.EVENT.CANCEL_EDITING, onEditingComplete);    playlistEventEmitter.on(EVENT.PLAYLIST.EVENT.CONFIRM_EDITING, onEditingComplete);
            ...
            function selectEvent () {
                ...
                if (userIsStaffOnUploadingTeam) {
                    ...
                    compileTemplate(EventTemplate);
                }
            }

            function onEditingComplete (event) {
            ...
            function onDestroy () {
                ...
                playlistEventEmitter.removeListener(EVENT.PLAYLIST.EVENT.CURRENT_CHANGE, onCurrentEventChange);
                playlistEventEmitter.removeListener(EVENT.PLAYLIST.EVENT.CANCEL_EDITING, onEditingComplete);   playlistEventEmitter.removeListener(EVENT.PLAYLIST.EVENT.CONFIRM_EDITING, onEditingComplete);
            }
        }
