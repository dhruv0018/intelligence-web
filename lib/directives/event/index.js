...
Event.directive('krossoverEvent', [
    'ROLES', 'SessionService', 'IndexingService', 'EventManager', 'EventEmitter',
    'EVENT_MAP', 'PlayManager', 'TagsetsFactory', 'GamesFactory', 'ScriptsService',
    'PlayersFactory',
    function directive(ROLES, session, indexing, eventManager, emitter, EVENT_MAP, playManager, tagsets, games, scripts, players) {
