 ...
 * @type {controller}
 */
EventController.$inject = ['$scope', '$q', 'ROLES', 'SessionService', 'IndexingService', 'PlayersFactory', 'EventManager', 'PlayManager', 'GamesFactory', 'PlaylistEventEmitter',];
function EventController($scope, $q, ROLES, session, indexing, players, eventManager, playManager, games, playlistEventEmitter) {
