...
Event.directive('krossoverEvent', [
    function directive() {
        ...
        function link($scope, element, attributes, controller) {
            ...
            /* TODO: Use and event instead */
            const removeCurrentEventWatch = $scope.$watch('eventManager.current', onCurrentEventChange);
...
Event.controller('Event.controller', [
    '$scope', '$q', 'ROLES', 'SessionService', 'IndexingService', 'TagsetsFactory', 'PlayersFactory', 'ScriptsService', 'EventManager', 'PlayManager', 'GamesFactory',
    function controller($scope, $q, ROLES, session, indexing, tagsets, players, scripts, eventManager, playManager, games) {
