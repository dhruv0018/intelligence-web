...
import EventTemplate from './template.html.js';
/**
 * Event
 * @module Event
 */
...
function krossoverEventHighlighting (
    ...
    function link (scope, element) {
        ...
        if (scope.event === eventManager.current) {
            ...
            if (isIndexer) button.scrollIntoView();
        }
...
Event.directive('krossoverEvent', [
    ...
    function directive(
        ...
        function link($scope, element, attributes, controller) {
            ...
            const game = play && play.gameId ? games.get(play.gameId) : games.get($scope.event.gameId);
            ...
            const userIsIndexer = currentUser.is(ROLES.INDEXER);
            const team = teams.get(uploaderTeamId);
            ...
            function compileTemplate(template) {
                ...
                if (userIsStaffOnUploadingTeam && $state.current.name !== 'Reel') {
                    ...
                    if (!userIsIndexer && league.belongsToYardFormatWhitelist()) {

                        $scope.event.formatYardField = true;
                    }
