...
Event.controller('Event.controller', [
    '$scope', '$q', 'ROLES', 'SessionService', 'IndexingService', 'TagsetsFactory', 'ScriptsService', 'EventManager', 'PlayManager', 'VideoPlayerInstance',
    function controller($scope, $q, ROLES, session, indexing, tagsets, scripts, event, play, videoplayer) {
