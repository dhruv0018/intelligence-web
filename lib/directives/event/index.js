...
Event.directive('krossoverEvent', [
    ...
    function directive(ROLES, session, indexing, event, emitter, EVENT_MAP) {
        ...
        function link($scope, element, attributes, controller) {
            ...
            var timeUpdateHandler = function(e) {
                ...
                var currentVideoTime = Math.floor(e.detail.time);
                var playEventTime = $scope.event.time;
                var eventOccurrenceTime = Math.floor(playEventTime - $scope.play.startTime);

                var highlightButton = element.find('button');

                if (currentVideoTime === eventOccurrenceTime) {
