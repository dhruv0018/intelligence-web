export default `
    ...
    <div class="association-film-exchange">
        ...
        <span class="film-exchange-conference-info">Conference: {{conference.name}} - {{filmExchange.gender}} {{sport.name}}</span>
        <span class="visible-to-teams" ng-show="filmExchange.isActive && !isEditingFilmExchange">Visible to teams</span>
        <span class="not-visible-to-teams" ng-show="!filmExchange.isActive && !isEditingFilmExchange">Not visible to teams</span>
