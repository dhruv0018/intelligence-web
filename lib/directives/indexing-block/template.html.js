...
<div class="indexing-block" ng-class="{ 'fullscreen': fullScreenEnabled }">
    ...
    <form class="indexing-form" name="formIndexing" role="form" novalidate>
        ...
        <indexer-fields
            ...
            on-forward="forwards"
        ></indexer-fields>
        <krossover-event-adjuster ng-if="indexing.isIndexing && indexing.showScript" events="play.current.events" event="event.current" video="game.video"></krossover-event-adjuster>
