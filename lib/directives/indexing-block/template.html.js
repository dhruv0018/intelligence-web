    ...
    <form class="indexing-form" name="formIndexing" role="form" novalidate>
        ...
        <div class="script">
            <span ng-repeat="scriptItem in event.current.indexerScript">
                ...
                <yard-dropdown-field ng-if="scriptItem.type === 'YARD' || scriptItem.type === 'TEXT' " event="event.current" field="event.current.fields[scriptItem.index]"></yard-dropdown-field>
