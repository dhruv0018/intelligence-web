            ...
            pre: function KOICheckboxDirectivePre(scope, element, attribute, controllers) {
                ...
                function childrenModelsWatch(newChildrenModels) {
                    ...
                    if (!newChildrenModels) {
                        ...
                        checkChildrenModels(ctrl.viewValue);
                        return;
                    }
                    ...
                    let newValue = anyChecked && newChildrenModelsKeys && anyChecked.length === newChildrenModelsKeys.length ? true : anyChecked && anyChecked.length ? -1 : false;
                ...
                function checkChildrenModels(value) {
                    ...
                    if (value === trueValue && childrenModels) {
