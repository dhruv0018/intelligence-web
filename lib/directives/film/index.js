...
Film.directive('krossoverFilm', [
    'ROLES', 'TeamsFactory', 'UsersFactory', 'GamesFactory', 'SessionService', 'ShareFilm.Modal', 'config',
    function directive(ROLES, teams, users, games, session, ShareFilmModal, config) {
