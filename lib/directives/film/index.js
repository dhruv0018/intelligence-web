    ...
    function directive(ROLES, teams, users, games, session, ShareFilmModal) {
        ...
        var film = {
            ...
            link: function($scope, element, attrs) {
                ...
                if (currentUser.is(ROLES.ATHLETE) && !$scope.game.isVideoTranscodeComplete()) {
                    $scope.hideFilm = true;
                } else if ($scope.isShared && !$scope.game.isVideoTranscodeComplete()) {
                    $scope.hideFilm = true;
                }
                ...
                if ($scope.isShared) {
                    ...
                    uploaderUser = users.get($scope.game.uploaderUserId);
                }
