...
import GameStatsPrintHeader from './game-stats-print-header';
...
import AdminGameInfoGameSidebar from './admin-game-info-game-sidebar';
import AdminGameInfoTeamSidebar from './admin-game-info-team-sidebar';
import AdminGameInfoContent from './admin-game-info-content';
...
const Directives = angular.module('Directives', [
    ...
    'AddReelDropdown',
    'StatsPrint',
    'GameStatsPrintHeader',
    'AdminGameInfoGameSidebar',
    'AdminGameInfoTeamSidebar',
    'AdminGameInfoContent'
]);
