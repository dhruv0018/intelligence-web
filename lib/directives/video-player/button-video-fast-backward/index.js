 ...
 */
buttonVideoFastBackwardDirective.$inject = [
    'VG_STATES',
    'config',
    '$document',
    'VIDEO_PLAYER_EVENTS',
 ...
 * @type {directive}
 */
function buttonVideoFastBackwardDirective (
    VG_STATES,
    config,
    $document,
    VIDEO_PLAYER_EVENTS,
    ...
    const definition = {
        ...
        templateUrl: 'lib/directives/video-player/button-video-fast-backward/template.html',
...
ButtonVideoFastBackward.directive('buttonVideoFastBackward', buttonVideoFastBackwardDirective);

export default ButtonVideoFastBackward;
