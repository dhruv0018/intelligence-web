...
ButtonVideoSlowForward.directive('buttonVideoSlowForward', [
    ...
    function directive(VG_STATES) {
        ...
        function onDestroy () {
            ...
            normalizePlayback();
            slowForwardButton.removeEventListener('mouseup', onMouseUp);
            slowForwardButton.removeEventListener('mousedown', onMouseDown);
        }
