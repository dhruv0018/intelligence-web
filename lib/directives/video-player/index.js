...
function VideoPlayerDirective (
    ...
    function link($scope, element, attributes) {
        ...
        $scope.isPublicUser = users.is(currentRole, ROLES.ANONYMOUS);

        if ($scope.isPublicUser) {
            // disable right-click context-menu on video player
            element[0].oncontextmenu = () => false;
        }
        ...
        $document.ready(() => {
            ...
            function fitVideo(videogularElement, mediaElement) {
                ...
                } else if (vgFullscreen.isFullScreen && !vgFullscreen.isFullScreen()) {
