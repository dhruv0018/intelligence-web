        ...
        $document.ready(() => {
            ...
            function fitVideo() {
                ...
                if (vgFullscreen.isFullScreen()) {
                    ...
                    videoPlayer.mediaElement.css('height', 'calc(100% - ' + VG_CONFIG.CONTROLS_HEIGHT + 'px)');
                    videoPlayer.mediaElement.css('max-width', '100%');
                    videoPlayer.mediaElement.css('max-height', 'calc(100% - ' + VG_CONFIG.CONTROLS_HEIGHT + 'px)');
                    ...
                    */
                    ...
                    let properVideoHeight = properWidth * (1 / VG_CONFIG.ASPECT_RATIO);
                    let properPlayerHeight = properVideoHeight + VG_CONFIG.CONTROLS_HEIGHT;
