        ...
        $document.ready(() => {
            ...
            function fitVideo(videogularElement, mediaElement) {
                ...
                if (vgFullscreen.isFullScreen()) {
                    ...
                    mediaElement.css('height', 'calc(100% - ' + VG_CONFIG.CONTROLS_HEIGHT + 'px)');
                    mediaElement.css('max-width', '100%');
                    mediaElement.css('max-height', 'calc(100% - ' + VG_CONFIG.CONTROLS_HEIGHT + 'px)');
                    ...
                    let parentWithHeight = getParentWithHeight(videogularElement);
