 ...
 */
buttonVideoStepBackwardDirective.$inject = [
    'config',
    '$document',
    '$timeout',
    'VideoPlayer'
 ...
 * @type {directive}
 */
function buttonVideoStepBackwardDirective (
    config,
    $document,
    $timeout,
    VideoPlayer
    ...
    const definition = {
        ...
        templateUrl: 'lib/directives/video-player/button-video-step-backward/template.html',
...
ButtonVideoStepBackward.directive('buttonVideoStepBackward', buttonVideoStepBackwardDirective);

export default ButtonVideoStepBackward;
