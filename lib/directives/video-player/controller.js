...
function VideoPlayerController (
    ...
    /*
     * Sets up a new video by getting its best or currently selected source
     * @param {Video} video
     * @returns {number} [-1,0,1]
     *   '-1': Invalid video
     *   '0': Video is already set to 'video', no change.
     *   '1': Video has been set to 'video'
     */
    videoPlayer.setVideo = (video) => {

        if (!video) return -1;
        if (currentVideo === video) return 0;
