...
function VideoPlayerController (
    ...
    $scope.vgSource = {
        ...
        videos: [$scope.videoPlayer.sources[0]]
    };
    ...
    // Store current time, used on source change
    let currentTime = 0;
    // Remember source changed to restore current time
    ...
    $scope.$watch('vgSource.videos', video => {
