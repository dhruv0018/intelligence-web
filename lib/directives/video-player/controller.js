...
function VideoPlayerController (
    ...
    let onChangeSource = (source) => {
        ...
        this.canPlay = false;
        // FIXME: This is a hack to get focus from the quality selector. TODO:
        // make the select-media-src a dropdown and not a 'select' element
        // then revert this commit that added this hack.
