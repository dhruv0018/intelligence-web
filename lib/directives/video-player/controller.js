...
function VideoPlayerController (DEVICE, $rootScope, $scope, videoPlayer, emitter) {
    ...
    function videoPlayerFullScreenWatch () {
        ...
        if (!videoPlayer.videogularElement) {

            return videoPlayer.videogularElement[0].classList.contains('fullscreen');
        }
    }
    ...
    function onFullScreenChange (isFullScreen) {
        ...
        emitter.register(new CustomEvent('fullscreen'), isFullScreen);
    }
