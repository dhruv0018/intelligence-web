...
function CuePointsDirective(
    ...
    let directive = {
        ...
        templateUrl: 'lib/directives/video-player/cuepoints/template.html',
    ...
    function cuePointLink($scope, $element, $attributes, $controllers) {
        ...
        function cuePointHit(cuePoint) {
            ...
            videoElement.addEventListener('seeked', boundVideoCanPlayCurrentTime);
        ...
        function videoCanPlayCurrentTime(cuePoint) {
            ...
            videoElement.removeEventListener('seeked', boundVideoCanPlayCurrentTime);
