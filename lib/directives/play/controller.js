...
Play.controller('Play.controller', [
    '$scope', '$state', '$stateParams', '$modal', 'config',
    'LeaguesFactory', 'TeamsFactory', 'GamesFactory',
    'PlayManager', 'EventManager',
    'SessionService', 'IndexingService',
    'VideoPlayer',
    'ROLES', 'VG_STATES', 'VIEWPORTS',
    function controller(
        $scope, $state, $stateParams, $modal, config,
        leagues, teams, games,
        playManager, eventManager,
