...
function PlayController (
    ...
    playlistEventEmitter.on(EVENT.PLAYLIST.EVENT.CONFIRM_EDITING, onConfirmEventEditing);
    ...
    */
    ...
    function onConfirmEventEditing (event) {

        if ($scope.play.id === event.playId) {
    ...
    function onDestroy () {
        ...
        playlistEventEmitter.removeListener(EVENT.PLAYLIST.EVENT.CONFIRM_EDITING, onConfirmEventEditing);
    }
}
