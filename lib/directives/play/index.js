...
Play.controller('Play.controller', [
    '$scope', '$state', '$stateParams', '$modal', '$interval', 'ROLES', 'SessionService', 'config', 'TeamsFactory', 'PlayManager', 'IndexingService', 'EventManager', 'Videoplayer', 'VideoPlayerInstance', 'VG_STATES', 'VIEWPORTS', 'GamesFactory',
    function controller($scope, $state, $stateParams, $modal, $interval, ROLES, session, config, teams, playManager, indexing, eventManager, videoplayer, videoPlayerInstance, VG_STATES, VIEWPORTS, games) {
        ...
        $scope.selectPlay = function() {
            ...
            // TODO: Work on scrolling, scrolling to top of play doesnt make
            // sense when the event list is long
