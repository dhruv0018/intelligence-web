...
Play.controller('Play.controller', [
    '$scope', '$state', '$stateParams', '$modal', '$interval', 'ROLES', 'EventEmitter', 'SessionService', 'config', 'TeamsFactory', 'PlayManager', 'IndexingService', 'EventManager', 'Videoplayer', 'VideoPlayerInstance', 'VG_STATES', 'VIEWPORTS', 'GamesFactory', 'PlayVideoMediator',
    function controller($scope, $state, $stateParams, $modal, $interval, ROLES, emitter, session, config, teams, playManager, indexing, eventManager, videoplayer, videoPlayerInstance, VG_STATES, VIEWPORTS, games, mediator) {
        ...
        if ($scope.play.clip) {
            ...
            emitter.on('VIDEO_COMPLETE_EMISSION', function() {
