...
Play.controller('Play.controller', [
    '$scope', '$modal', 'ROLES', 'SessionService', 'config', 'TeamsFactory', 'PlayManager', 'IndexingService', 'EventManager', 'VideoPlayerInstance', 'VG_EVENTS', 'VG_STATES',
    function controller($scope, $modal, ROLES, session, config, teams, playManager, indexing, eventManager, videoplayer, VG_EVENTS, VG_STATES) {
