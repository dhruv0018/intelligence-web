...
Play.controller('Play.controller', [
    '$scope', '$modal', '$interval', 'ROLES', 'SessionService', 'config', 'TeamsFactory', 'PlayManager', 'IndexingService', 'EventManager', 'VideoPlayerInstance', 'VG_EVENTS', 'VG_STATES',
    function controller($scope, $modal, $interval, ROLES, session, config, teams, playManager, indexing, eventManager, videoPlayerInstance, VG_EVENTS, VG_STATES) {
        ...
        $scope.isReelsPlayer = !!playManager.isReelsPlayer;
