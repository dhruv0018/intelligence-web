...
Play.directive('krossoverPlay', [
    ...
    function directive(session, ROLES, leaguesFactory, gamesFactory, teamsFactory) {
        ...
        function link($scope, element, attributes) {
            ...
            $scope.isTeamMember = session.currentUser.currentRole.teamId === $scope.game.uploaderTeamId;
