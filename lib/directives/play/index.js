...
Play.controller('Play.controller', [
    '$scope', '$modal', 'ROLES', 'SessionService', 'TeamsFactory', 'PlayManager', 'EventManager', 'VideoPlayerInstance', 'VG_EVENTS', 'VG_STATES',
    function controller($scope, $modal, ROLES, session, teams, playManager, eventManager, videoplayer, VG_EVENTS, VG_STATES) {
        ...
        videoplayer.then(function(vp) { $scope.vp = vp; });
        /**
         * Opens this play.
         */
