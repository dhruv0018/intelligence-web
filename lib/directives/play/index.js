...
Play.directive('krossoverPlay', [
    'SessionService', 'ROLES', 'LeaguesFactory', 'GamesFactory', 'TeamsFactory', 'UsersFactory',
    function directive(session, ROLES, leagues, games, teams, users) {
        ...
        function link($scope, element, attributes) {
            ...
            */
            ...
            if (isIndexer) {
                ...
                $scope.isEditable = true;
            } else if (isACoachOfUploadersTeam) {
                $scope.isEditable = true;
            }
...
Play.controller('Play.controller', [
    '$scope', '$state', '$modal', '$interval', 'ROLES', 'SessionService', 'config', 'TeamsFactory', 'PlayManager', 'IndexingService', 'EventManager', 'VideoPlayerInstance', 'VG_EVENTS', 'VG_STATES', 'VideoElement', 'VIEWPORTS',
    function controller($scope, $state, $modal, $interval, ROLES, session, config, teams, playManager, indexing, eventManager, videoPlayerInstance, VG_EVENTS, VG_STATES, videoPlayerElement, VIEWPORTS) {
