...
<div>
    <div class="playHeadingContainer" ng-click="openPlay(play)">
        <check-box feature="SelectPlays" ng-if="isTeamMember" checked="play.isSelected" ng-click="togglePlaySelection($event, play)"></check-box>
