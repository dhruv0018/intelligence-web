            ...
            link: {
                pre: function(scope, elem, attr, controller) {
                    ...
                    scope.fitVideo = function fitVideo() {
                        ...
                        if ((currentVideoWidth / parentHeight) > (16 / 9)) {
                            currentVideoWidth = parentHeight * 16 / 9;
                        ...
                        scope.playerHeight = Math.min(elem.parent()[0].getBoundingClientRect().height, (currentVideoWidth / 16 * 9) + scope.controlsHeight);
                    };
