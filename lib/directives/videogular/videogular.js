...
videogular.directive('videogular', [
    '$rootScope', '$window', 'VG_STATES', 'VG_EVENTS', 'VG_UTILS', 'VideoElement', 'PlayManager',
    function($rootScope, $window, VG_STATES, VG_EVENTS, VG_UTILS, videoElementService, playManager) {
        ...
        return {
            ...
            link: {
                pre: function(scope, elem, attr, controller) {
                    ...
                    scope.fitVideo = function fitVideo(elem) {
                        ...
                        if (angular.element($window)[0].fullScreenAPI && angular.element($window)[0].fullScreenAPI.isFullScreen()) {
                            ...
                            if (!parentWithHeight) {
                                ...
                                */
                                ...
                                var properVideoHeight = properWidth * (1 / ASPECT_RATIO);
                                var properPlayerHeight = properVideoHeight + scope.controlsHeight;
                                ...
                                * only fit the player within the parent's height if on desktop */
                                if ($rootScope.viewport.name === 'Desktop' && properPlayerHeight > parentHeight) {
                                    ...
                                    properVideoHeight = properPlayerHeight - scope.controlsHeight;
                                    properWidth = properVideoHeight * ASPECT_RATIO;
                                }
                    ...
                    function getParentWithHeight(elem) {
                        ...
                        if (height > 50) {
                            // arbitrary height, but large enough not to give a false-positive
                            return parent;
                        } else {
