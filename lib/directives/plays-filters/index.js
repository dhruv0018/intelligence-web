...
PlaysFilters.directive('playsFilter', [
    'PlaysFactory', 'PlayersFactory', 'TeamsFactory', 'LeaguesFactory', 'FiltersetsFactory', 'FILTERSET_CATEGORY_TYPES', 'FILTERSET_CATEGORY_TYPES_IDS',
    function directive(plays, players, teams, leagues, filtersets, FILTERSET_CATEGORY_TYPES, FILTERSET_CATEGORY_TYPES_IDS) {
        ...
        function post(scope) {
            ...
            scope.$watch('activeFilters', function(activeFilters) {
                ...
                if (activeFilters.length === 0) {
                    ...
                    scope.totalPlays.forEach(function(play) {
