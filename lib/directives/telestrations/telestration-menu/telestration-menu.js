...
Telestrations.directive('telestrationMenu', [
    '$timeout', 'VG_STATES', 'VG_EVENTS', 'TELESTRATION_TYPES', 'TELESTRATION_COLORS', 'dropdownToolStates',
    function($timeout, VG_STATES, VG_EVENTS, TELESTRATION_TYPES, TELESTRATION_COLORS, toolStates) {
        return {
            restrict: 'E',
