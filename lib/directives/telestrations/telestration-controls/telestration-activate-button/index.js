...
Telestrations.directive('telestrationActivateButton', [
    function() {
        return {
            ...
            link: function telestrationActivateButtonLink(scope, elem, attr, telestrationsController) {

                scope.toggleEditingTelestrations = function toggleEditingTelestrations() {

                    telestrationsController.isEditingEnabled = !telestrationsController.isEditingEnabled;
                };
            }
        };
    }
