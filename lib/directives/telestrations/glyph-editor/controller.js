...
GlyphEditorController.$inject = ['$scope', '$element', 'TelestrationsEventEmitter', 'TELESTRATION_COLORS'];

function GlyphEditorController($scope, $element, TelestrationsEventEmitter, TELESTRATION_COLORS) {
