        ...
        function postlink(scope, elem, attr, telestrationsController) {
            ...
            var timeUpdateHandler = function timeUpdateHandler(e) {
                ...
                scope.telestrationsEntity.forEach(function(savedTelestration) {
                    ...
                    if ((timeDelta <= TELESTRATIONS_CONSTANTS.MAX_TIME_DELTA) && savedTelestration.glyphs && savedTelestration.glyphs.length) {
            ...
            elem.on('$destroy', function $destroyTelestrations() {
                ...
                scope.telestrationsEntity.glyphs.forEach(function removeGlyphListeners(glyph) {
