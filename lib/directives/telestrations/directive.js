...
function TelestrationsDirective(
    ...
    function postlink($scope, $element, $attributes, telestrationsController) {
        ...
        $scope.play = $scope.playId ? getPlay($scope.playId) : undefined;
        let playStartTime = $scope.play ? $scope.play.startTime : undefined;
        ...
        $scope.$watch('playId', function hideTelestrationsIfPlayChanges(newPlayId, oldPlayId) {
            ...
            if (newPlayId !== oldPlayId) {
                ...
                $scope.play = $scope.playId ? getPlay($scope.playId) : undefined;
                playStartTime = $scope.play ? $scope.play.startTime : undefined;
        ...
        function onMouseup(event) {
            ...
            telestrationsController.validateCurrentTelestration(event);
        }
        ...
        function telestrationStart(mouseEvent) {
            ...
            if (!telestration) {
                ...
                if ($scope.play) {
                    ...
                    $scope.play.hasTelestrations = true;
                }
            }
        ...
        function getPlay(playId) {
            ...
            if (playId) {
                try {
                    play = plays.get(playId);
                } catch (err) {
                    play = selfEditedPlays.get(playId);
                }
            }
    ...
    return {
        ...
        templateUrl: 'lib/directives/telestrations/template.html',
        link: {
            pre: function() {
...
export default TelestrationsDirective;
