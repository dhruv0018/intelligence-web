...
function TelestrationsDirective(
    ...
    function postlink($scope, $element, $attributes, telestrationsController) {
        ...
        if (telestrationsController.permissions === TELESTRATION_PERMISSIONS.EDIT) {
            ...
            TelestrationsEventEmitter.on(TELESTRATION_EVENTS.DISABLE_DRAW, removeMouseHandlers);
            TelestrationsEventEmitter.on(TELESTRATION_EVENTS.ENABLE_DRAW, addMouseHandlers);
        }
        ...
        CuePointEventEmitter.on(CUE_POINT_EVENTS.TELESTRATION, onCuePointTelestrationEvent);
        ...
        function onCuePointTelestrationEvent(event) {
            ...
            for (var index in $scope.telestrationsEntity) {
                ...
                let absoluteTelestrationTime = event.time + currentPlayStartTime;
        ...
        function onVideoTimeUpdate(event) {
            ...
            // Set the currentTelestration time to the updated time
            currentTelestrationTime = event.target.currentTime + currentPlayStartTime;
        }
