    ...
    function($state, $window, $timeout, emitter, EVENT_MAP, Glyphs, TELESTRATIONS_CONSTANTS, videoPlayerEventEmitter, TELESTRATION_PERMISSIONS) {
        ...
        function postlink(scope, element, attributes, telestrationsController) {
            ...
            if (telestrationsController.permissions === TELESTRATION_PERMISSIONS.EDIT) {
                ...
                telestrationsController.telestrationContainerElement.on('mouseenter', addMouseHandlers);
                telestrationsController.telestrationContainerElement.on('mouseleave', removeMouseHandlers);

                telestrationsController.telestrationContainerElement.on('telestration:onEditModeBlur', function onClickAddMouseHandlers(event) {
                    self.console.log('containerElement received telestration:onEditModeBlur event');
                    telestrationsController.telestrationContainerElement.off('click', addMouseHandlers);
                    telestrationsController.telestrationContainerElement.on('click', addMouseHandlers);
                });
            }
