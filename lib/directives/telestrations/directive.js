...
module.exports = [
    '$state', '$window', 'EventEmitter', 'EVENT_MAP', 'GlyphFactory', 'PlayManager', 'TELESTRATIONS_CONSTANTS',
    function($state, $window, emitter, EVENT_MAP, Glyphs, PlayManager, TELESTRATIONS_CONSTANTS) {
        ...
        function postlink(scope, elem, attr, telestrationsController) {
            ...
            var telestrationStart = function telestrationStart(mouseEvent) {
                ...
                if (!telestrationsController.isEditEnabled) return;
            ...
            var playVideoHandler = function playVideoHandler(e) {
                ...
                telestrationsController.isEditEnabled = false;
            ...
            var canPlayHandler = function canPlayHandler() {
                ...
                telestrationsController.isEditEnabled = true;
                scope.$apply();
