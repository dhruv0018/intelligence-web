...
function TelestrationsDirective(
    ...
    function postlink($scope, $element, $attributes, telestrationsController) {
        ...
        let currentPlayStartTime = getPlayStartTime($scope.playId);
        ...
        $scope.$watch('playId', function hideTelestrationsIfPlayChanges(newPlayId, oldPlayId) {
            ...
            if (newPlayId !== oldPlayId) {
                ...
                currentPlayStartTime = getPlayStartTime(newPlayId);
        ...
        function getPlayStartTime(playId) {
            ...
            let play = plays.get(playId);

            return play ? play.startTime : 0;
        }

        /*
         * Telestration times are saved to 2 decimal places.
         * Make sure numbers are at least rounded to the nearest value. e.g. 6.74 + 1.06 = 7.8000000000001
         * which should actually be 7.8
         */
        function convertToSafeTelestrationTime(value) {
        ...
        function onCuePointTelestrationEvent(event) {
            ...
            for (var index in $scope.telestrationsEntity) {
                ...
                let absoluteTelestrationTime = convertToSafeTelestrationTime(event.time + currentPlayStartTime);
        ...
        function onVideoTimeUpdate(event) {
            ...
            // Set the currentTelestration time to the updated time
            currentTelestrationTime = convertToSafeTelestrationTime(event.target.currentTime + currentPlayStartTime);
        }
