...
module.exports = [
    '$state', '$window', '$timeout', 'EventEmitter', 'EVENT_MAP', 'GlyphFactory', 'TELESTRATIONS_CONSTANTS', 'VideoPlayerEventEmitter', 'TelestrationEventEmitter', 'TELESTRATION_PERMISSIONS',
    function($state, $window, $timeout, emitter, EVENT_MAP, Glyphs, TELESTRATIONS_CONSTANTS, videoPlayerEventEmitter, TelestrationEventEmitter, TELESTRATION_PERMISSIONS) {
        ...
        function postlink(scope, element, attributes, telestrationsController) {
            ...
            var telestrationStart = function telestrationStart(mouseEvent) {
                ...
                if (!telestrationsController.$canTelestrate()) return;
            ...
            if (telestrationsController.permissions === TELESTRATION_PERMISSIONS.EDIT) {
                ...
                TelestrationEventEmitter.on('disableDraw', function handleDisableDraw(event) {

                    removeMouseHandlers();
                });

                TelestrationEventEmitter.on('enableDraw', function handleEnableDraw(event) {
