...
module.exports = [
    '$state', '$window', '$timeout', 'EventEmitter', 'EVENT_MAP', 'GlyphFactory', 'PlayManager', 'TELESTRATIONS_CONSTANTS', 'VideoPlayerEventEmitter',
    function($state, $window, $timeout, emitter, EVENT_MAP, Glyphs, PlayManager, TELESTRATIONS_CONSTANTS, videoPlayerEventEmitter) {
        ...
        function postlink(scope, element, attributes, telestrationsController) {
            ...
            var svgContainer = element.find('ng-transclude');
            ...
            var handleFullscreenEvent = function handleFullscreenEvent(isFullscreen) {
                ...
                if (isFullscreen) {
                    telestrationsController.telestrationContainerElement.addClass('fullscreen');
                } else {
                    telestrationsController.telestrationContainerElement.removeClass('fullscreen');
                }
                resizeTelestrationContext();
            };
