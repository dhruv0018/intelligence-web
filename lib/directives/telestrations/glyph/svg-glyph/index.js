...
const SvgGlyph = angular.module('SvgGlyph', []);

// Directive
SvgGlyph.directive('svgGlyph', SvgGlyphDirective);

SvgGlyphDirective.$inject = [
    '$window',
    '$timeout',
