        ...
        return {
            ...
            link: function($scope, elem, attr, ctrls) {
                ...
                var glyphDrawing = function glyphDrawing(mouseEvent) {
                    ...
                    if (!telestrationsCtrl.isEditEnabled) return;
                ...
                var glyphDrawEnd = function glyphDrawEnd(mouseEvent) {
                    ...
                    if (isDrawing) {
                        ...
                        telestrationsCtrl.currentTelestration.glyphs.removeGlyph($scope.glyphObject);
                        $scope.$apply();
                    }
                    ...
                    // save new glyph
                    telestrationsCtrl.$save(telestrationsCtrl.$updated);
                };
