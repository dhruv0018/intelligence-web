...
module.exports = [
    '$window', 'VideoPlayerEventEmitter',
    function($window, videoPlayerEventEmitter) {
        return {
            restrict: 'E',
            scope: {
                glyphObject: '='
            ...
            link: function($scope, elem, attr, ctrls) {
                ...
                var glyphDrawEnd = function glyphDrawEnd(mouseEvent) {
                    ...
                    telestrationsCtrl.telestrationSVGContainer.unbind('mouseleave', glyphDrawOutOfBounds);
                ...
                if (telestrationsCtrl.isDrawing) {
                    ...
                    telestrationsCtrl.telestrationSVGContainer.bind('mouseleave', glyphDrawOutOfBounds);
                }
