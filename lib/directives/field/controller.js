...
class FieldController {
    ...
    constructor(scope) {
        ...
        if (this.scope.field.value) {

            this.scope.displayValue.name = this.scope.field.value.name;
        }
        else if (this.scope.field.isRequired) {

            this.scope.displayValue.name = 'Select';
        }
        else {

            this.scope.displayValue.name = 'Optional';
        }
