...
Teams.controller('TeamsController', [
    '$rootScope', '$scope', '$state', '$localStorage', 'TeamValue', 'TeamsFactory', 'SportsFactory', 'LeaguesFactory', 'SchoolsFactory',
    function controller($rootScope, $scope, $state, $localStorage, team, teams, sports, leagues, schools) {
