...
Teams.controller('TeamController', [
    '$rootScope', '$scope', '$state', '$stateParams', 'UsersResource', 'TeamValue', 'TeamsFactory', 'SchoolsResource',
    function controller($rootScope, $scope, $state, $stateParams, users, team, teams, schools) {
