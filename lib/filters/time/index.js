...
Time.filter('millisecondsAsDaysHoursMinutes', [
    ...
    function filter(utilities) {
        ...
        return function(time) {
            ...
            console.log('padZero(days)', padZero(days));
            console.log('time', time);
            time = padZero(hours) + 'h ' + padZero(minutes) + 'm ';
            time = days ? padZero(days) + 'd ' + time : time;
...
Time.filter('millisecondsAsHoursMinutesSeconds', [
    ...
    function filter(utilities) {
        ...
        return function(time) {
            ...
            time = padZero(minutes) + 'm ' + padZero(seconds) + 's ';
            time = hours ? padZero(hours) + 'h ' + time : time;
