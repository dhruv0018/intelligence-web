...
function ArenaEventsFilter(
    ...
    const OUTCOME = ARENA_CHART.ARENA_EVENTS.OUTCOME;
    ...
    function isArenaEventInShotsFilter(arenaEvent, shotsQuery) {
        ...
        if (arenaEvent.outcome === OUTCOME.MADE && shotsQuery.made) {
            return true;
        } else if (arenaEvent.outcome === OUTCOME.MISSED && shotsQuery.missed) {
            return true;
        } else if (arenaEvent.outcome === OUTCOME.SAVED && shotsQuery.saved) {
            return true;
        } else if (arenaEvent.outcome === OUTCOME.BLOCKED && shotsQuery.blocked) {
            return true;
        } else {
            return false;
        }
