...
Indexing.run([
    ...
    function run($templateCache) {
        ...
        $templateCache.put('indexing-sidebar-notes.html', require('./indexing-sidebar-notes.html'));
        $templateCache.put('indexing-sidebar-playlist.html', require('./indexing-sidebar-playlist.html'));
