...
Indexing.service('Indexing.EventService', [
    ...
    function service(indexing, tags, play) {
        ...
        this.activeEventVariableIndex = 1;
        ...
        this.activeEventVariableValue = function() {
            ...
            return this.eventVariableValue(this.activeEventVariableIndex);
        };
        ...
        this.clearActiveEventVariableValue = function() {
            ...
            this.current.variableValues[this.activeEventVariableIndex] = null;
        };
        ...
        this.allEventVariablesHaveValues = function() {
            ...
            return self.current &&
                ...
                return !!self.eventVariableValue(eventVariableIndex);
            });
        };
