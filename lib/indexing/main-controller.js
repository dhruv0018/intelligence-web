...
Indexing.controller('Indexing.Main.Controller', [
    'config', '$window', '$rootScope', '$scope', '$sce', '$state', '$stateParams', '$modal', 'VIDEO_STATUSES', 'GAME_STATUSES', 'VG_EVENTS', 'SessionService', 'AlertsService', 'IndexingService', 'PlaysFactory', 'PlayersFactory', 'Indexing.TagsService', 'Indexing.PlayService', 'Indexing.EventService', 'Indexing.Sidebar',
