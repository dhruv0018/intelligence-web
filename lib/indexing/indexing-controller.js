...
Indexing.controller('indexing.Controller', [
    ...
    function controller($window, $rootScope, $scope, $sce, $state, $stateParams, VIDEO_STATUSES, VG_EVENTS, indexing, plays, players, sidebar) {
        ...
        this.save = function() {
            ...
            plays.save(self.currentPlay).then(
                ...
                function success() {
                    ...
                    self.plays.push(self.currentPlay);
                    self.currentPlay = {};
        ...
        $scope.sources = function() {
            ...
            if (self.game.video.status !== VIDEO_STATUSES.COMPLETE) return sources;

            self.game.videoTranscodeProfiles.forEach(function(profile) {

                if (profile.status === VIDEO_STATUSES.COMPLETE) {
