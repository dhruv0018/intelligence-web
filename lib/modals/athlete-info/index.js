...
AthleteInfo.controller('AthleteInfo.controller', [
    '$scope', '$state', '$modalInstance', 'GamesFactory', 'AlertsService', 'Athlete', 'ResourceManager', 'SessionService',
    function controller($scope, $state, $modalInstance, games, alerts, athlete, resourceManager, session) {
