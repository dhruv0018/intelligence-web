...
AthleteInfo.controller('AthleteInfo.controller', [
    '$scope', '$state', '$modalInstance', 'GamesFactory', 'UsersFactory', 'AlertsService', 'Athlete', 'ResourceManager', 'SessionService',
    function controller($scope, $state, $modalInstance, games, users, alerts, athlete, resourceManager, session) {
        ...
        $scope.savePlayer = function() {
            if ($scope.athleteForm.$valid) {
                $scope.$parent.save($scope.athlete);
                $modalInstance.close();
            }
        };
