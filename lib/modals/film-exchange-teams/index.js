 ...
 * @type {controller}
 */
FilmExchangeTeams.controller('FilmExchangeTeams.controller', ['$scope', 'FilmExchangeFactory',
    function controller($scope, filmExchange) {
        //this will come from a conference service, as soon as it is available
        var conferenceId = 'US-NCAA+B1G+Male+1';
