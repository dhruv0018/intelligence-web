...
<div class="run-distribution-modal">
    ...
    <header class="modal-header">
        ...
        <h3 class="modal-title">
            <span ng-if="!batchHistory">Run Distribution</span>
            <span ng-if="batchHistory">Historical Distribution Summary</span>
        </h3>
        <button class="btn btn-default" ng-disabled="loadingDistributionSummary || noGamesToDistribute" ng-click="reserveGames()" ng-if="!batchHistory">
    ...
    <div class="modal-body" ng-class="{'loading-summary': loadingDistributionSummary}">
        ...
        <h3 class="summary-report-title" ng-if="!loadingDistributionSummary && !noGamesToDistribute && !batchHistory">Summary Report</h3>
        <h3 class="summary-report-title" ng-if="!loadingDistributionSummary && batchHistory">Historical Report: {{batchDistributionSummary.attributes.executedAt|date:'MMM d, y h:mm:ss a'}}</h3>
        <div class="summary-report-container" ng-if="!loadingDistributionSummary && !noGamesToDistribute">
            <div class="summary-report-table" ng-repeat="summaryReport in batchDistributionSummary.attributes">
                <h4 ng-if="summaryReport.name">{{summaryReport.name}}</h4>
                <table ng-if="summaryReport.name" class="table table-striped">
                    <thead>
                        <tr>
        ...
        <button class="toggle-detail-btn btn btn-default" ng-click="showMoreDetail = !showMoreDetail" ng-hide="loadingDistributionSummary || noGamesToDistribute || batchHistory">
