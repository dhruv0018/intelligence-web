...
<div class="run-distribution-modal">
    ...
    <header class="modal-header">
        ...
        <button class="btn btn-default" ng-disabled="loadingDistributionSummary" ng-click="reserveGames()">Reserve Games</button>
        <i class="icon icon-remove" ng-click="$dismiss()"></i>

    </header>

    <div class="modal-body" ng-class="{'loading-summary': loadingDistributionSummary}">
        <div class="loading-display" ng-if="loadingDistributionSummary">
            <krossover-spinner size="40px"></krossover-spinner>
            <p>Generating distribution summary, please wait...</p>
        </div>
        <h3 class="summary-report-title" ng-if="!loadingDistributionSummary">Summary Report</h3>
        <div class="summary-report-container" ng-if="!loadingDistributionSummary">
        ...
        <button class="toggle-detail-btn btn btn-default" ng-click="showMoreDetail = !showMoreDetail" ng-hide="loadingDistributionSummary">
