...
ShareFilm.controller('ShareFilm.controller', [
    '$scope', '$state', '$modalInstance', 'ShareFilm.Modal', 'BasicModals', 'Game', 'GamesFactory', 'UsersFactory',
    function controller($scope, $state, $modalInstance, modal, basicModal, game, games, users) {
