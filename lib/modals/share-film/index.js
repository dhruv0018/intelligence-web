...
ShareFilm.controller('ShareFilm.controller', [
    '$scope', '$state', '$modalInstance', '$timeout', 'config', 'ROLES', 'SessionService', 'ShareFilm.Modal', 'BasicModals', 'Film', 'GamesFactory', 'ReelsFactory', 'UsersFactory',
    function controller($scope, $state, $modalInstance, $timeout, config, ROLES, session, modal, basicModal, film, games, reels, users) {
