...
ShareFilm.controller('ShareFilm.controller', [
    '$scope', '$state', '$modalInstance', '$timeout', 'config', 'SessionService', 'ShareFilm.Modal', 'BasicModals', 'Film', 'GamesFactory', 'ReelsFactory', 'UsersFactory', 'TeamsFactory', 'PlayersFactory', 'ROLES',
    function controller($scope, $state, $modalInstance, $timeout, config, session, modal, basicModal, film, games, reels, users, teams, players, ROLES) {
