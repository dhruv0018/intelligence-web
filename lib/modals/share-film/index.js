...
ShareFilm.controller('ShareFilm.controller', [
    '$scope', '$state', '$modalInstance', '$timeout', 'config', 'ROLES', 'SessionService', 'ShareFilm.Modal', 'BasicModals', 'Film', 'GamesFactory', 'ReelsFactory', 'UsersFactory', 'ROLES',
    function controller($scope, $state, $modalInstance, $timeout, config, ROLES, session, modal, basicModal, film, games, reels, users, ROLES) {
