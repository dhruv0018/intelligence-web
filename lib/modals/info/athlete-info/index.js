...
AthleteInfo.controller('AthleteInfo.controller', [
    '$scope', '$state', '$modalInstance', '$timeout', 'GamesFactory', 'UsersFactory', 'PlayersFactory', 'AlertsService', 'Athlete', 'ResourceManager', 'SessionService',
    function controller($scope, $state, $modalInstance, $timeout, games, users, players, alerts, athlete, resourceManager, session) {
