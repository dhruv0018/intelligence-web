...
AthleteInfo.controller('AthleteInfo.controller', [
    '$scope', '$state', '$modalInstance', '$timeout', 'GamesFactory', 'UsersFactory', 'PlayersFactory', 'TeamsFactory', 'AlertsService', 'Athlete', 'ResourceManager', 'SessionService', 'EMAIL_REQUEST_TYPES',
    function controller($scope, $state, $modalInstance, $timeout, games, users, players, teams, alerts, athlete, resourceManager, session, EMAIL_REQUEST_TYPES) {
