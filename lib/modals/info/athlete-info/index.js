...
AthleteInfo.controller('AthleteInfo.controller', [
    '$scope', '$state', '$modalInstance', '$timeout', 'GamesFactory', 'UsersFactory', 'PlayersFactory', 'TeamsFactory', 'AlertsService', 'Athlete', 'SessionService', 'EMAIL_REQUEST_TYPES',
    function controller($scope, $state, $modalInstance, $timeout, games, users, players, teams, alerts, athlete, session, EMAIL_REQUEST_TYPES) {
