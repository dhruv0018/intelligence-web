...
AssistantInfo.controller('AssistantInfo.controller', [
    '$scope', '$state', '$modalInstance', 'GamesFactory', 'UsersFactory', 'TeamsFactory', 'AlertsService', 'Assistant', 'ResourceManager', 'SessionService', 'ROLE_TYPE', 'ROLES',
    function controller($scope, $state, $modalInstance, games, users, teams, alerts, assistant, resourceManager, session, ROLE_TYPE, ROLES) {
        ...
        $scope.assistantCoachRole = $scope.assistant.getRole(ROLES.ASSISTANT_COACH, teams.get(session.currentUser.currentRole.teamId));
