...
AssistantInfo.controller('AssistantInfo.controller', [
    '$scope', '$state', '$timeout', '$modalInstance', 'GamesFactory', 'UsersFactory', 'TeamsFactory', 'AlertsService', 'Assistant', 'ResourceManager', 'SessionService', 'ROLE_TYPE', 'ROLES', 'EMAIL_REQUEST_TYPES',
    function controller($scope, $state, $timeout, $modalInstance, games, users, teams, alerts, assistant, resourceManager, session, ROLE_TYPE, ROLES, EMAIL_REQUEST_TYPES) {
        ...
        $scope.assistantCoachRole = $scope.assistant.roleTypes[ROLE_TYPE.ASSISTANT_COACH].filter(function(role) {
