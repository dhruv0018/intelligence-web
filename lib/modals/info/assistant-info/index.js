...
AssistantInfo.controller('AssistantInfo.controller', [
    '$scope', '$state', '$modalInstance', 'GamesFactory', 'UsersFactory', 'TeamsFactory', 'AlertsService', 'Assistant', 'ResourceManager', 'SessionService', 'ROLE_TYPE', 'ROLES', 'EMAIL_REQUEST_TYPES',
    function controller($scope, $state, $modalInstance, games, users, teams, alerts, assistant, resourceManager, session, ROLE_TYPE, ROLES, EMAIL_REQUEST_TYPES) {
