...
ExcelUpload.controller('ExcelUpload.controller', [
    '$http','$scope', '$modalInstance', 'config', 'PlayersFactory', 'teamsFactory',
    function controller($http, $scope, $modalInstance, config, players, teams) {
        $scope.errors = [];
