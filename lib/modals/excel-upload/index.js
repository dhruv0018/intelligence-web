...
ExcelUpload.controller('ExcelUpload.controller', [
    '$scope', '$state', '$modalInstance', 'GamesFactory', 'Game', 'AlertsService', 'Options',
    function controller($scope, $state, $modalInstance, games, game, alerts, options) {
        console.log(options);
    }
]);
