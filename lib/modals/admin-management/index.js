...
AdminManagement.controller('AdminManagement.controller', [
    '$scope', '$state', '$modalInstance', 'Game', 'GAME_STATUSES', 'UsersFactory', 'DeleteGame.Modal', 'SelectIndexer.Modal',
    function controller($scope, $state, $modalInstance, game, GAME_STATUSES, users, DeleteGameModal, SelectIndexerModal) {
        ...
        $scope.reassignIndexer = function() {
            game.unassign();
            SelectIndexerModal.open(game, false);
        };

        $scope.reassignQAer = function() {
            game.unassign();
            SelectIndexerModal.open(game, true);
        };
