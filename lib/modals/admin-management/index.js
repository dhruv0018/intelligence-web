...
AdminManagement.controller('AdminManagement.controller', [
    '$scope', '$state', '$modalInstance', 'Game', 'GAME_STATUSES', 'UsersFactory', 'DeleteGame.Modal', 'SelectIndexer.Modal', 'EMAIL_REQUEST_TYPES', 'SessionService',
    function controller($scope, $state, $modalInstance, game, GAME_STATUSES, users, DeleteGameModal, SelectIndexerModal, EMAIL_REQUEST_TYPES, session) {
