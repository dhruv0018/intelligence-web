...
AdminManagement.controller('AdminManagement.controller', [
    '$scope', '$state', '$modalInstance', 'Game', 'GAME_STATUSES', 'UsersFactory', 'DeleteGame.Modal',
    function controller($scope, $state, $modalInstance, game, GAME_STATUSES, users, DeleteGameModal) {
        $scope.GAME_STATUSES = GAME_STATUSES;
        $scope.game = game;
        $scope.assignment = game.currentAssignment();
