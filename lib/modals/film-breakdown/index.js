...
FilmBreakdown.controller('FilmBreakdown.controller', [
    '$scope', '$state', '$modalInstance', 'TeamsFactory', 'PlayManager', 'ReelsFactory',
    function controller($scope, $state, $modalInstance, teams, playManager, reels) {

        $scope.sources = $scope.game.getVideoSources();
        $scope.videoTitle = 'filmBreakdownModal';
