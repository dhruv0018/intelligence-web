...
AddProfileTeam.controller('AddProfileTeam.controller', [
    ...
    function controller($scope,
        ...
        if ($scope.profileTeam.teamId) {
            ...
            $scope.teamSport = sports.get($scope.teamLeague.id);
        ...
        $scope.saveProfileTeam = function() {
            ...
            if ($scope.editingExistingTeam) {
                ...
                let teamToEdit = teams.get($scope.profileTeam.teamId);
                teamToEdit.leagueId = $scope.teamLeague.id;
                teamToEdit.name = $scope.profileTeam.name;
                teamToEdit.save();
