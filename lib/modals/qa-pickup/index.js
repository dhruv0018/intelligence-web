...
QaPickup.controller('QaPickup.controller', [
    '$scope', '$state', '$window', '$modalInstance', 'Utilities', 'GamesFactory', 'Game', 'TeamsFactory', 'LeaguesFactory', 'SportsFactory', 'SessionService',
    function controller($scope, $state, $window, $modalInstance, utilities, games, gameId, teams, leagues, sports, session) {
