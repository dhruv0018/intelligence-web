    ...
    function (ROLE_TYPE, ROLES) {
        ...
        return function(roles, role) {
            ...
            angular.forEach(roles, function(filterRole) {
                ...
                switch (filterRole.type.id) {

                case ROLE_TYPE.ADMIN:

                    /* Only Super Admins can edit Admins. */
                    if (role.type.id == ROLES.SUPER_ADMIN) {
                        filtered.push(filterRole);
                    }
                    break;

                case ROLE_TYPE.INDEXER:
                case ROLE_TYPE.PARENT:
                case ROLE_TYPE.ATHLETE:
                ...
                case ROLE_TYPE.HEAD_COACH:
                case ROLE_TYPE.ASSISTANT_COACH:
