...
Users.controller('UserController', [
    '$rootScope', '$scope', '$state', '$stateParams', 'SessionService', 'ROLES', 'UsersFactory', 'UserValue',
    function controller($rootScope, $scope, $state, $stateParams, session, ROLES, users, userValue) {
