...
Users.controller('UsersController', [
    '$rootScope', '$scope', '$state', '$modal', '$stateParams', 'SessionService', 'ROLES', 'UsersFactory', 'TeamsFactory', 'LeaguesFactory', 'SportsFactory', 'UserValue',
    function controller($rootScope, $scope, $state, $modal, $stateParams, session, ROLES, users, teams, leagues, sports, userValue) {
