...
Users.controller('UserController', [
    '$rootScope', '$scope', '$state', '$stateParams', 'SessionService', 'ROLES', 'UsersFactory',
    function controller($rootScope, $scope, $state, $stateParams, session, ROLES, users) {
...
Users.controller('UsersController', [
    '$rootScope', '$scope', '$state', '$modal', 'SessionService', 'ROLES', 'UsersFactory', 
    function controller($rootScope, $scope, $state, $modal, session, ROLES, users) {
        ...
        $scope.ATHLETE = ROLES.ATHLETE;
        $scope.currentUser = session.currentUser;
        $scope.statuses = [{value: true, label: 'Active'}, {value: false, label: 'Not Active'}];
