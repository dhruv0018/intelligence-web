...
Users.controller('Users.User.Controller', [
    '$rootScope', '$scope', '$state', '$stateParams', '$localStorage', 'SessionService', 'AuthenticationService', 'AlertsService', 'ROLES', 'Users.User.Service', 'UsersFactory',
    function controller($rootScope, $scope, $state, $stateParams, $localStorage, session, auth, alerts, ROLES, user, users) {
