        ...
        for (i = 1; i <= Object.keys(ROLE_ID).length; i += 1) {
            ...
            if (userRoles.length > 0) {
                ...
                userRoles.forEach(function(userRole){
                    // adding indexed objects to quickly reference in krossoverRoleListItem directive
                    userRole.indexedLeagues = $scope.indexedLeagues;
                    userRole.indexedSports = $scope.indexedSports;
                });
