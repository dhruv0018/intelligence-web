...
Login.controller('LoginController', [
    '$rootScope', '$scope', '$location', '$state', '$http', 'UsersFactory', 'SessionService', 'AuthenticationService',
    function controller($rootScope, $scope, $location, $state, $http, users, session, auth) {
        ...
        * validity of the password again. */
        ...
        $scope.login = function() {
            ...
            try {
                ...
                auth.loginUser(email, password, persist, function(user) {
