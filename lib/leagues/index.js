...
Leagues.controller('LeagueController', [
    '$rootScope', '$scope', '$state', '$stateParams', '$localStorage', 'LeaguesFactory', 'TeamsResource', 'SportsFactory', 'TagsetsFactory',
    function controller($rootScope, $scope, $state, $stateParams, $localStorage, leagues, teams, sports, tagsets) {
