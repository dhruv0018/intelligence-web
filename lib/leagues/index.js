...
/**
 * Leagues value. Holds data for the current league..
 * @module Leagues
 * @name League
 * @type {Value}
 */
...
Leagues.controller('LeagueController', [
    '$rootScope', '$scope', '$state', '$stateParams', 'League', 'LeaguesFactory', 'TeamsResource', 'SportsFactory',
    function controller($rootScope, $scope, $state, $stateParams, league, leagues, teams, sports) {
        if ($stateParams.id) {
...
Leagues.controller('LeaguesController', [
    '$rootScope', '$scope', '$state', 'League', 'LeaguesFactory', 'SportsFactory',
    function controller($rootScope, $scope, $state, league, leagues, sports) {
