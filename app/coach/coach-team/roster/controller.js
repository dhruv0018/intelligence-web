...
CoachTeamRosterController.$inject = [
    '$q',
    '$rootScope',
    '$scope',
    '$state',
 ...
 * @type {controller}
 */
function CoachTeamRosterController($q, $rootScope, $scope, $state, $stateParams, $filter, config, ROLES, leagues, positionsets, teams, players, users, session) {
    $scope.ROLES = ROLES;
...
export default CoachTeamRosterController;
