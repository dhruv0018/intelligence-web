...
IndexingSidebarNotesController.$inject = [
    '$scope',
    '$rootScope',
    'GAME_NOTE_TYPES',
    'GamesFactory',
 ...
 * @module Indexing
 * @name IndexingSidebarNotesController
 * @type {Controller}
 */
function IndexingSidebarNotesController($scope, $rootScope, GAME_NOTE_TYPES, games, videoPlayer) {
...
export default IndexingSidebarNotesController;
