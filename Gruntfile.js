...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            unprefixed: {
                src: ['fonts.css', 'icons.css', 'theme/animate.min.css', 'build/icons.data.svg.css', 'node_modules/angular-multi-select/angular-multi-select.css', 'node_modules/angular-material/angular-material.css', 'build/build.css', 'build/theme.css'],
