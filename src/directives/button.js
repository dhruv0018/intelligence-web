...
IntelligenceWebClient.directive('buttonAddNew', [
    ...
    function($parse) {
        ...
        var directive = {
            ...
            restrict: TO += ELEMENTS,
            transclude: true,
            template: '<button ng-attr-id="{{elemId}}" class="btn-add-new" data-ng-click="add()"><span data-ng-transclude></span> <i class="btn btn-primary pull-right icon icon-plus"></i></button>',
