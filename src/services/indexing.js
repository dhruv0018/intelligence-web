...
IntelligenceWebClient.factory('IndexingService', IndexingService);

IndexingService.$inject = [
    'config',
    'TagsetsFactory',
    'TagsManager',
    'PlaysManager',
...
function IndexingService (
    ...
    let service = {
        ...
        */
        save: function () {
            ...
            let event = eventManager.current;
            ...
            if (event.isEndAndStart) {
                ...
                let tag = tagsManager.tagset.tags[tagId];

                /* Get the child tag ID of the tag. */
                let childId = tag.children[0];
    ...
    playlistEventEmitter.on('EVENT_SELECT', service.onEventSelect.bind(service));
